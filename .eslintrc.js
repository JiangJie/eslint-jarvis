...
module.exports = {
    ...
    'rules': {
        ...
        'no-extra-parens': [2, 'all'], // 避免不必要的括号
        ...
        'no-unused-expressions': [2], // 禁止未使用过的表达式
        ...
        'max-depth': [2, { max: 3 }], // 强制块语句的最大可嵌套深度为3
        'max-nested-callbacks': [2, { max: 2 }], // 强制回调函数最大嵌套深度为2
        ...
        'emplate-tag-spacing': [2, 'never'], // 禁止在模板标记和它们的字面量之间有空格
